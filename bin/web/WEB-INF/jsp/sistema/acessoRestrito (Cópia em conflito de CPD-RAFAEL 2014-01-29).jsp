		...
		<div id="conteudoPagina">
			<table border="0" cellpadding="0" cellspacing="0" style="width: 100%; height: 100%;">
				<tr style="height: 150px;" valign="bottom">
					<td align="center">
						<img src="<c:url value="/imagens/icones/iconeAtencao.png"/>" alt="Aten&ccedil;&atilde;o" border="0">
					</td>
				</tr>
				<tr style="height: 25px;" valign="middle" class="textoGrande">
					<td align="center">
						<b>Atenção:</b> O acesso a esta Função está restrito aos usuários selecionados.
					</td>
				</tr>
