							...
							<display:table htmlId="displaytag" name="${usuarioList}" id="usuario" sort="list" export="false" style="width: 570px;">
								...
								<display:column media="html" title="" style="width: 50px; text-align:center;">
									<div style="float: left;">
										<a href="#" onclick="consultar('<c:url value="/usuario/consultarUsuario/${usuario.id}"/>', 'Informações do Usuário');">
											<img class="linkSemBorda" src="../imagens/icones/iconeConsultar.png">
										</a>
									</div>
									<a href="#" onclick="excluir('<c:url value="/usuario/removerUsuario/${usuario.id}"/>');">
