				...
				<table border="0" cellpadding="0" cellspacing="0" style="width: 460px;">
					...
					<tr style="height: 10px;">
						<td style="width: 570px;" colspan="3">
							<input type="password" class="k-textbox" name="usuario.password" value="${usuario.password}" maxlength="15" style="width: 200px;">
						</td>
					</tr>
					<tr style="height: 25px;" valign="bottom">
					...
					<tr style="height: 10px;">
						<td style="width: 570px;" colspan="3">
							<select name="usuario.ativo" value="${usuario.ativo}" style="width: 205px;">
